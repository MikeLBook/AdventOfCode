...
/*
    ...
    For the below day2.Part enum, only ONE and TWO exist.
    THREE can be added, but again it must be added here where day2.Part is defined at all.
    ...
    To invoke an enum, you can use: day2.Part.ONE
    To get the string value of an enum, you can use: day2.Part.ONE.name
    To get a list of all possible enums, you can use: day2.Part.values() // [ONE, TWO]
    To get an enum matching a string, you can use day2.Part.valueOf("ONE") // ONE

    The day2.Part enum below is the minimal implementation.
 */
enum class Part {
    ONE, TWO
}
...
/*
    ...
    In the case of day2.Outcome, each instantiated enum is supplied with a property called 'points' of type Int.
    e.g. day2.Outcome.WIN.points == 6 // true
...
/*
    ...
    For the day2.Legend enum, then, I've supplied two properties for each instance.
    The property named part1 is of type day2.Symbol (the next enum to be defined).
    The property named part2 is of type day2.Outcome, defined just above.
    e.g. day2.Legend.X.part1 == day2.Symbol.A // true
         day2.Legend.Z.part2 == day2.Outcome.WIN // true
 */
...
/*
    ...
    This was necessary, because 'beats' is also of type day2.Symbol.
    day2.Symbol.A would not be able to pass day2.Symbol.B to its constructor.
    Other than that, there's nothing new going on with the day2.Symbol enum.
    e.g. day2.Symbol.A.points == 1 // true
         day2.Symbol.B.beats == day2.Symbol.A // true
 */
...
fun main() {
    ...
    fun calculate(part: Part): Int {
        return lines.map { line ->
            ...
            // if pair.second == "X", then legend == day2.Legend.X
            val legend = Legend.valueOf(pair.second)
            // calculating points differently depending on which day2.Part was passed into calculate
            if (part == Part.ONE) {
                when {
